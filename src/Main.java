...
public class Main {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		case 5:
			System.out.println(
					"Escribe una funcion area triangulo que te calcule el area de un triangulo y se le pasa por parametros la base y la altura");
			System.out.println(areaTriangulo(2, 4));
			break;

		case 17:
			System.out.println("Escribe un programa que nos escriba los 10 primeros numeros que no sean multiplos de 2 ni 3.");
			Ejercicio17();
			break;
